...
namespace density {
    ...
    public:
        ...
        void encapsulate(uint8_t *RESTRICT pointer, const uint_fast64_t bytes);
    ...
    public:
        ...
        ~teleport_t();
        void change_input_buffer(const uint8_t *RESTRICT in, const uint_fast64_t available_in);
