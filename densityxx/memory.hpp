...
namespace density {
    ...
    // teleport_t.
    DENSITY_INLINE teleport_t::teleport_t(const uint_fast64_t size)
    {
    ...
    DENSITY_INLINE teleport_t::~teleport_t()
    {
