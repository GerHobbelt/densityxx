...
main(void)
{
    ...
    FILE *rfp = fopen("sharcxx.exe.c3", "rb");
    FILE *wfp = fopen("sharcxx.exe.c3.sharc", "wb");
    density::file_buffer_t<1 << 19, 1 << 19> buffer(rfp, wfp);
    density::block_encode_t<density::lion_encode_t> block_encode;
